...
{
    /// <summary>
    /// Http Status code definitions as per https://tools.ietf.org/html/rfc2616#section-6.1.1
    /// </summary>
    public class HttpStatusCode
    {
        // TODO: 3. Make sure the below codes mirror https://tools.ietf.org/html/rfc2616#section-6.1.1
        ...
        internal HttpStatusCode(int code, string reasonPhrase)
        {
            Code = code;
