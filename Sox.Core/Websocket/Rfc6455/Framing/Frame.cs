...
namespace Sox.Core.Websocket.Rfc6455.Framing
{
    ...
    public class Frame
    {
        ...
        public static Frame CreatePing() => new Frame(
            isFinal: true,
            rsv1: false,
            rsv2: false,
            rsv3: false,
        ...
        /// </summary>
        /// <returns>A Ping Websocket Frame</returns>
        public static Frame CreatePong() => new Frame(
            isFinal: true,
            rsv1: false,
            rsv2: false,
            rsv3: false,
        ...
        /// </summary>
        /// <returns>A Ping Websocket Frame</returns>
        public static Frame CreateClose() => new Frame(
            isFinal: true,
            rsv1: false,
            rsv2: false,
            rsv3: false,
        ...
        /// </summary>
        /// <returns>A Ping Websocket Frame</returns>
        public static Frame CreateClose(CloseStatusCode closeCode) => new Frame(
            isFinal: true,
            rsv1: false,
            rsv2: false,
            rsv3: false,
        ...
        /// </returns>
        public static async Task<Frame> UnpackAsync(Stream stream)
        {
