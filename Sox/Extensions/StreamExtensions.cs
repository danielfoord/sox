...
namespace Sox.Extensions
{
    ...
    internal static class StreamExtensions
    {
        ...
        internal static async Task<byte[]> ReadBytesAsync(this Stream stream, int bytesToRead, int bufferSize = 1024)
        {
        ...
        internal static async Task WriteBytesAsync(this Stream stream, byte[] bytes)
        {
        ...
        internal static async Task WriteAndFlushAsync(this Stream stream, byte[] bytes)
        {
